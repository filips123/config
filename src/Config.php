...
class Config extends AbstractConfig
{
    ...
    protected function loadFromFile($path, ParserInterface $parser = null)
    {
        ...
        foreach ($paths as $path) {
            if ($parser === null) {
                ...
                // Try to load file
                $this->data = array_replace_recursive($this->data, (array) $parser->decode(file_get_contents($path)));
    ...
    protected function loadFromString($configuration, ParserInterface $parser)
    {
        ...
        // Try to parse string
        $this->data = array_replace_recursive($this->data, (array) $parser->decode($configuration));
    }
